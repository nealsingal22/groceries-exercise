...
print('---------------')
print(f"THERE ARE " + str(num_products) + " PRODUCTS.")
...
# Source: https://www.youtube.com/watch?v=Noy20XaMqho&t=581s (Groceries Walkthrough)
# Watched the video walkthrough for support on the product sorting and counting
